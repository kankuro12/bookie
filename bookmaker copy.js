...
class PuppeteerService {
    ...
    constructor(loginlink, crawllink, apiUrl) {
        this.browser = null;
        this.page = null;
        this.loginPage = null;
    ...
    login(username, password) {
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                await this.loginPage.waitForSelector('#account');
    ...
    //         this.login('BKR760638', 'Sagar@123')
    //             .then(async (data) => {
    //                 await this.initBrowser();
    //                 const userAgent = randomUseragent.getRandom();
    //                 const crawlResults = { isValidPage: true, pageSource: null };
...
const puppeteerService = new PuppeteerService('https://www.bookmaker.eu/', 'https://be.bookmaker.eu/en/sports/basketball/nba/nba/', 'https://be.bookmaker.eu/BetslipProxy.aspx/GetSchedule');
const data = await puppeteerService.initiate();
